...
const alertVariants = cva(
  cn(
    "group/alert relative grid w-full grid-cols-[0_1fr] items-start gap-y-1 rounded-none border-2 border-black px-4 py-3 text-left text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]",
